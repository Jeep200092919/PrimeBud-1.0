...
# Estilos CSS - Interface ultra limpa e moderna
st.markdown("""
<style>
    /* Tema principal */
    .main {
...
MODES_CONFIG = {
    ...
    "primebud_1_5": {
        ...
        "system_prompt": "Você é o PrimeBud 1.5, a versão híbrida premium. Combine clareza com profundidade, sendo detalhado quando necessário mas sempre mantendo objetividade e estrutura clara.",
        "temperature": 0.75,
        "max_tokens": 3000,
    },
    "primebud_2_0": {
        ...
        "system_prompt": "Você é o PrimeBud 2.0, a versão mais avançada. Forneça análises profundas, respostas extremamente detalhadas e completas, explorando múltiplas perspectivas e nuances. Seja o mais abrangente possível.",
        "temperature": 0.85,
        "max_tokens": 4000,
    },
}
...
if st.session_state.user is None:
    ...
    with col2:
        ...
        st.markdown("<p style='text-align: center; font-size: 1.1rem; color: #888;'>Assistente de IA de Nova Geração</p>", unsafe_allow_html=True)
        st.markdown("---")
    ...
    if st.session_state.current_chat_id is None:
        ...
        st.markdown("<p style='text-align: center; font-size: 1.2rem; color: #888; margin-bottom: 2rem;'>Escolha um modo e comece a conversar</p>", unsafe_allow_html=True)
